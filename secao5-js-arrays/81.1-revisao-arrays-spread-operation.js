...
nomes.pop()
console.log(nomes)
console.log(novoNomes); console.log();

// Spread Operator -> cria um novo array que não está relacionado com o anterior, "espalhando" os valores para ambos,
// em vez de apontar para o mesmo local
