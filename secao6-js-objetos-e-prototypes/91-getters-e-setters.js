...
function Produto(nome, preco, estoque) {
    ...
    Object.defineProperty(this, 'estoque', {
        configurable: true,
        enumerable: true,
        // não vai precisar da propriedade value, vai utilizar get e set
        // não vai precisar também de writable se tem get e set
...
p1.estoque = 500;
console.log('Novo estoque :', p1.estoque); console.log();

// ex2: factory function
